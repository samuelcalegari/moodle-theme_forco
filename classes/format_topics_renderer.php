...
class theme_forco_format_topics_renderer extends format_topics_renderer {
    ...
    public function print_single_section_page($course, $sections, $mods, $modnames, $modnamesused, $displaysection) {
        ...
        $sectiontitle .= html_writer::tag('span', $this->convertLinkButton($sectionnavlinks['previous']), array('class' => 'mdl-left'));
        $sectiontitle .= html_writer::tag('span', $this->convertLinkButton($sectionnavlinks['next']), array('class' => 'mdl-right'));
        // Title attributes
        $classes = 'sectionname';
